...
const projects = [
  ...
  },
  {
    ...
    icon: <Code className="w-6 h-6" />,
    link: 'https://hironikatravels.online/',
    date: '2024',
    tags: ['Vibecoding', 'Web Development'],
  },
  {
    title: 'EchelonX AI',
    description: 'AI-powered business transformation site offering chatbots, voicebots, automation, and analytics for Education, Real Estate, and Enterprise.',
    icon: <Code className="w-6 h-6" />,
  ...
  },
  {
    ...
    icon: <Code className="w-6 h-6" />,
    link: 'https://www.bingeandparty.com/',
    date: '2024',
    tags: ['Vibecoding', 'Web Development'],
  },
  {
